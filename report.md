...
- Создание пустого репозитория (папка `.test-repo/`).
...
- Добавление изменённого файла в staging.
...
`git remote add origin git@github.com:rawline/test-repo.git`
